...
final supportedLanguages = {
  ...
  _AppLanguageEnum.catalan.index: AppLanguage(
    _AppLanguageEnum.catalan.index,
    "català",
    "Catalan",
    const Locale("ca"),
  ),
  ...
  _AppLanguageEnum.italian.index: AppLanguage(
    _AppLanguageEnum.italian.index,
    "Italiano",
    "Italian",
    const Locale("it"),
  ),
  _AppLanguageEnum.japanese.index: AppLanguage(
    _AppLanguageEnum.japanese.index,
    "日本語",
    "Japanese",
    const Locale("ja"),
  ),
  _AppLanguageEnum.polish.index: AppLanguage(
    _AppLanguageEnum.polish.index,
    "Polski",
    "Polish",
    const Locale("pl"),
  ),
  ...
  _AppLanguageEnum.russian.index: AppLanguage(
    _AppLanguageEnum.russian.index,
    "Русский",
    "Russian",
    const Locale("ru"),
  ),
  _AppLanguageEnum.slovak.index: AppLanguage(
    _AppLanguageEnum.slovak.index,
    "slovenčina",
    "Slovak",
    const Locale("sk"),
  ),
  _AppLanguageEnum.spanish.index: AppLanguage(
    _AppLanguageEnum.spanish.index,
    "Español",
    "Spanish",
    const Locale("es"),
  ),
  _AppLanguageEnum.turkish.index: AppLanguage(
    _AppLanguageEnum.turkish.index,
    "Türkçe",
    "Turkish",
    const Locale("tr"),
  ),
