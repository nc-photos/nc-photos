...
extension PrefExtension on Pref {
  ...
  Future<bool> setSetupProgress(int value) => _set<int>(
    PrefKey.setupProgress,
    value,
    (key, value) => provider.setInt(key, value),
  );
...
extension AccountPrefExtension on AccountPref {
  ...
  Future<bool> setLastNewCollectionType(int? value) {
    if (value == null) {
      ...
      return _set<int>(
        AccountPrefKey.lastNewCollectionType,
        value,
        (key, value) => provider.setInt(key, value),
      );
    }
