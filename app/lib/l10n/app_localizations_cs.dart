...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get deleteSelectedSuccessNotification => 'Všechny položky úspěšně přidány';
  ...
  @override
  String get archiveSelectedSuccessNotification => 'Všechny položky úspěšně archivovány';
  ...
  @override
  String get unarchiveSelectedSuccessNotification => 'Všechny položky úspěšně odebrány z archivu';
  ...
  @override
  String get removeSelectedFromAlbumFailureNotification => 'Nepodařilo se odebrat položky z alba';
  ...
  @override
  String get connectingToServerInstruction => 'Přihlaste se prosím v otevřeném prohlížeči';
  ...
  @override
  String get signIn2faHintText => 'Pokud máte na serveru povolené dvoufaktorové ověření, použijte heslo aplikace';
  ...
  @override
  String get rootPickerSubHeaderText => 'Budou zobrazeny pouze fotky uvnitř vybraných složek. Klepněte na Přeskočit pro zahrnutí všech';

  @override
  String get rootPickerNavigateUpItemText => '(vrátit se)';

  @override
  String get rootPickerUnpickFailureNotification => 'Nepodařilo se zrušit výběr položky';

  @override
  String get rootPickerListEmptyNotification => 'Vyberte prosím alespoň jednu složku nebo klepněte na Přeskočit pro zahrnutí všech';

  @override
  String get setupWidgetTitle => 'Začínáme';

  @override
  String get setupSettingsModifyLaterHint => 'Toto lze později změnit v nastavení';

  @override
  String get setupHiddenPrefDirNoticeDetail => 'Tato aplikace vytvoří složku na serveru Nextcloud pro ukládání předvoleb. Neupravujte a neodebírejte ji, pokud se nechystáte odstranit tuto aplikaci';
  ...
  @override
  String get settingsMemoriesSubtitle => 'Zobrazit fotografie pořízené v minulosti';
  ...
  @override
  String get settingsAccountLabelDescription => 'Nastavte štítek, který má být zobrazen na místě URL serveru';
  ...
  @override
  String get settingsShareFolderDialogDescription => 'Toto nastavení odpovídá parametru share_folder v souboru config.php. Obě hodnoty MUSÍ být shodné.\n\nNajděte prosím stejnou složku, jaká je nastavena v config.php.';

  @override
  String get settingsShareFolderPickerDescription => 'Najděte stejnou složku, jaká je nastavena v souboru config.php. Pokud jste parametr nenastavili, stiskněte výchozí.';
  ...
  @override
  String get settingsPhotosDescription => 'Přizpůsobit obsah zobrazený na kartě Fotky';
  ...
  @override
  String get settingsViewerDescription => 'Přizpůsobit prohlížeč obrázků a videí';

  @override
  String get settingsScreenBrightnessTitle => 'Jas obrazovky';

  @override
  String get settingsScreenBrightnessDescription => 'Přepsat systémovou úroveň jasu';

  @override
  String get settingsForceRotationTitle => 'Ignorovat uzamčení otáčení';

  @override
  String get settingsForceRotationDescription => 'Otáčet obrazovku i při zakázaném automatickém otáčení';
  ...
  @override
  String get settingsViewerCustomizeBottomAppBarTitle => 'Přizpůsobit spodní lištu aplikace';

  @override
  String get settingsShowDateInAlbumTitle => 'Seskupit fotky podle data';

  @override
  String get settingsShowDateInAlbumDescription => 'Použijte pouze při řazení alba podle času';

  @override
  String get settingsCollectionsCustomizeNavigationBarTitle => 'Přizpůsobit navigační lištu';

  @override
  String get settingsImageEditTitle => 'Editor';

  @override
  String get settingsImageEditDescription => 'Přizpůsobit vylepšení a editor obrázků';

  @override
  String get settingsEnhanceMaxResolutionTitle2 => 'Rozlišení obrázků pro vylepšení';

  @override
  String get settingsEnhanceMaxResolutionDescription => 'Fotky větší než zadaná hodnota budou zmenšeny.\n\nFotky s vyšším rozlišením vyžadují výrazně vyšší množství paměti a času ke zpracování. Snižte toto nastavení, pokud aplikace spadla při vylepšování vašich fotek.';

  @override
  String get settingsImageEditSaveResultsToServerTitle => 'Ukládat výsledky na server';

  @override
  String get settingsImageEditSaveResultsToServerTrueDescription => 'Výsledky budou ukládány na server, na zařízení budou uloženy pouze při selhání';

  @override
  String get settingsImageEditSaveResultsToServerFalseDescription => 'Výsledky budou ukládány na toto zařízení';
  ...
  @override
  String get settingsSeedColorDescription => 'Použito k odvození všech barev použitých v aplikaci';

  @override
  String get settingsSeedColorSystemColorDescription => 'Použít systémovou barvu';
  ...
  @override
  String get settingsSeedColorPickerSystemColorButtonLabel => 'POUŽÍT SYSTÉMOVOU BARVU';

  @override
  String get settingsUseBlackInDarkThemeTitle => 'Tmavší motiv';

  @override
  String get settingsUseBlackInDarkThemeTrueDescription => 'Použít černou barvu ve tmavém motivu';

  @override
  String get settingsUseBlackInDarkThemeFalseDescription => 'Použít tmavší šedou ve tmavém motivu';
  ...
  @override
  String get settingsPhotosTabSortByNameTitle => 'Řazení podle názvu souboru ve Fotkách';
  ...
  @override
  String get settingsAppLockDescription => 'Při povolení již budete při otevření aplikace dotázáni na přihlášení. Tato funkce vás NEochrání proti reálným útokům.';

  @override
  String get settingsAppLockSetupBiometricFallbackDialogTitle => 'Vyberte náhradu při nedostupnosti biometriky';

  @override
  String get settingsAppLockSetupPinDialogTitle => 'Nastavte PIN pro odemčení aplikace';

  @override
  String get settingsAppLockConfirmPinDialogTitle => 'Znovu zadejte stejný PIN';

  @override
  String get settingsAppLockSetupPasswordDialogTitle => 'Nastavte heslo pro odemčení aplikace';

  @override
  String get settingsAppLockConfirmPasswordDialogTitle => 'Znovu zadejte stejné heslo';
  ...
  @override
  String get settingsExperimentalDescription => 'Funkce, které nejsou připraveny ke každodennímu používání';

  @override
  String get settingsExpertTitle => 'Pokročilé';

  @override
  String get settingsExpertWarningText => 'Před pokračováním se ujistěte, že přesně chápete, co dělá která možnost';

  @override
  String get settingsClearCacheDatabaseTitle => 'Vymazat databázi souborů';

  @override
  String get settingsClearCacheDatabaseDescription => 'Vymazat informace o souborech v mezipaměti a spustit úplnou opětovnou synchronizaci se serverem';

  @override
  String get settingsClearCacheDatabaseSuccessNotification => 'Databáze úspěšně vymazána. Je doporučeno restartovat aplikaci';

  @override
  String get settingsManageTrustedCertificateTitle => 'Spravovat důvěryhodné certifikáty';

  @override
  String get settingsUseNewHttpEngine => 'Použít nový engine HTTP';

  @override
  String get settingsUseNewHttpEngineDescription => 'Nový engine HTTP je založený na projektu Chromium a podporuje standardy jako HTTP/2* a HTTP/3 QUIC*.\n\nOmezení:\nCertifikáty podepsané samy sebou již nemohou být spravovány námi. Aby vaše certifikáty CA fungovaly, musíte je importovat do systémového pověřeného úložiště.\n\n* Pro HTTP/2 a HTTP/3 je vyžadováno HTTPS';
  ...
  @override
  String get settingsCaptureLogsDescription => 'Pomoc vývojáři při diagnostice chyb';

  @override
  String get settingsTranslatorTitle => 'Překladatel';

  @override
  String get settingsRestartNeededDialog => 'Restartujte aplikaci pro použití změn';

  @override
  String get writePreferenceFailureNotification => 'Nepodařilo se upravit nastavení';
  ...
  @override
  String get exifSupportNextcloud28Notes => 'Podpora na straně klienta doplňuje váš server. Aplikace bude zpracovávat soubory a atributy, které nejsou podporované Nextcloudem';

  @override
  String get exifSupportConfirmationDialogTitle2 => 'Povolit podporu EXIF na straně klienta?';

  @override
  String get captureLogDetails => 'Pořízení záznamů pro hlášení chyby:\n\n1. Povolte toto nastavení\n2. Reprodukujte problém\n3. Zakažte toto nastavení\n4. Vyhledejte soubor nc-photos.log ve složce stahování\n\n*Pokud problém způsobí pád aplikace, nelze pořídit žádné protokoly. V takovém případě se obraťte na vývojáře, který vám poskytne další pokyny';
  ...
  @override
  String get rootPickerSkipConfirmationDialogContent2 => 'Budou zahrnuty všechny vaše soubory. Tato akce může zvýšit využití paměti a snížit výkon';
  ...
  @override
  String get webSelectRangeNotification => 'Držte Shift + klikněte pro vybrání všech položek uprostřed';

  @override
  String get mobileSelectRangeNotification => 'Dlouze stiskněte další položku pro vybrání všech položek mezi nimi';
  ...
  @override
  String get updateDateTimeFailureNotification => 'Nepodařilo se upravit datum a čas';

  @override
  String get albumDirPickerHeaderText => 'Vyberte složky, které mají být přidruženy';

  @override
  String get albumDirPickerSubHeaderText => 'Do tohoto alba budou zařazeny pouze fotografie v přidružených složkách';

  @override
  String get albumDirPickerListEmptyNotification => 'Vyberte alespoň jednu složku';
  ...
  @override
  String get albumImporterSubHeaderText => 'Navržené složky jsou zobrazeny níže. Podle počtu souborů na vašem serveru může tato akce chvíli trvat';
  ...
  @override
  String get editAccountConflictFailureNotification => 'Již existuje účet se stejným nastavením';
  ...
  @override
  String get albumEditDragRearrangeNotification => 'Chcete-li ručně změnit uspořádání položky, dlouze ji stiskněte a přetáhněte';
  ...
  @override
  String get shareSelectedEmptyNotification => 'Vyberte nějaké fotky ke sdílení';
  ...
  @override
  String get restoreSelectedSuccessNotification => 'Všechny položky úspěšně obnoveny';
  ...
  @override
  String get deletePermanentlyConfirmationDialogContent => 'Vybrané položky budou trvale odstraněny ze serveru.\n\nTato akce je nevratná';

  @override
  String get albumSharedLabel => 'Sdílené';

  @override
  String get metadataTaskProcessingNotification => 'Zpracovávání metadat obrázků na pozadí';
  ...
  @override
  String get serverCertErrorDialogTitle => 'Certifikát serveru je nedůvěryhodný';

  @override
  String get serverCertErrorDialogContent => 'Server může být napaden nebo se někdo snaží ukrást vaše informace';
  ...
  @override
  String get emptyTrashbinConfirmationDialogContent => 'Všechny položky budou ze serveru trvale odstraněny.\n\nTato akce je nevratná';
  ...
  @override
  String get shareMethodPreviewDescription => 'Sdílet náhled se sníženou kvalitou do ostatních aplikací (podporuje pouze obrázky)';

  @override
  String get shareMethodOriginalFileTitle => 'Původní soubor';

  @override
  String get shareMethodOriginalFileDescription => 'Stáhnout původní soubor a sdílet jej do ostatních aplikací';

  @override
  String get shareMethodPublicLinkTitle => 'Veřejný odkaz';

  @override
  String get shareMethodPublicLinkDescription => 'Vytvořit nový veřejný odkaz na serveru. Kdokoli s odkazem bude mít přístup k souboru';

  @override
  String get shareMethodPasswordLinkTitle => 'Odkaz chráněný heslem';

  @override
  String get shareMethodPasswordLinkDescription => 'Vytvořit nový odkaz chráněný heslem na serveru';
  ...
  @override
  String get multipleFilesLinkShareDialogContent => 'Nextcloud nepodporuje sdílení odkazu pro více souborů. Aplikace místo toho zkopíruje soubory do nové složky a sdílí ji';
  ...
  @override
  String get unshareLinkShareDirDialogContent => 'Tato složka byla vytvořena aplikací pro sdílení více souborů jako odkaz. Nyní již není sdílena s žádnou stranou, chcete tuto složku odstranit?';
  ...
  @override
  String get sharedAlbumInfoDialogContent => 'Sdílené album umožňuje přístup k jednomu albu více uživatelům na stejném serveru. Před pokračováním si pozorně přečtěte omezení';
  ...
  @override
  String get migrateDatabaseFailureNotification => 'Nepodařilo se přesunout databázi';
  ...
  @override
  String get homeFolderNotFoundDialogContent => 'Opravte prosím adresu URL WebDAV níže. Správnou adresu naleznete ve webovém rozhraní Nextcloud.';

  @override
  String get homeFolderInputInvalidEmpty => 'Zadejte název vaší domovské složky';
  ...
  @override
  String get createCollectionDialogAlbumDescription2 => 'Album s extra funkcemi, dostupné pouze s touto aplikací';

  @override
  String get createCollectionDialogFolderLabel => 'Složka';

  @override
  String get createCollectionDialogFolderDescription => 'Zobrazit fotky uvnitř složky';
  ...
  @override
  String get favoriteFailureNotification => 'Nepodařilo se přidat do oblíbených';
  ...
  @override
  String get unfavoriteFailureNotification => 'Nepodařilo se odebrat z oblíbených';

  @override
  String get createCollectionDialogTagLabel => 'Štítek';

  @override
  String get createCollectionDialogTagDescription => 'Zobrazit fotky s určitými štítky';
  ...
  @override
  String get enhanceIntroDialogDescription => 'Fotografie jsou zpracovávány lokálně v zařízení. Ve výchozím nastavení jsou zmenšeny na 2048x1536. Výstupní rozlišení můžete upravit v nastavení';

  @override
  String get enhanceLowLightTitle => 'Vylepšení při slabém osvětlení';

  @override
  String get enhanceLowLightDescription => 'Rozjasní vaše fotografie pořízené v prostředí se slabým osvětlením';
  ...
  @override
  String get deletePermanentlyLocalConfirmationDialogContent => 'Vybrané položky budou z tohoto zařízení trvale odstraněny.\n\nTato akce je nevratná';

  @override
  String get enhancePortraitBlurTitle => 'Rozmazání portrétu';

  @override
  String get enhancePortraitBlurDescription => 'Rozmaže pozadí fotografií, nejlépe funguje u portrétů';
  ...
  @override
  String get enhanceSuperResolution4xDescription => 'Zvětší vaše fotografie na čtyřnásobek původního rozlišení (podrobnosti o tom, jak se zde uplatňuje maximální rozlišení, najdete v nápovědě).';
  ...
  @override
  String get enhanceStyleTransferStyleDialogDescription => 'Převede styl obrázku z referenčního obrázku na vaše fotky';
  ...
  @override
  String get enhanceColorPopDescription => 'Desaturuje pozadí fotografií, nejlépe funguje u portrétů';
  ...
  @override
  String get enhanceRetouchDescription => 'Automaticky retušuje vaše fotografie, celkově vylepší barvu a živost';
  ...
  @override
  String get searchLandingPeopleListEmptyText2 => 'Otevřete nastavení pro přepnutí poskytovatele nebo si otevřete nápovědu pro více informací';
  ...
  @override
  String get gpsPlaceAboutDialogContent => 'Zde uvedené místo je pouze hrubým odhadem a není zaručeno, že je přesné. Nevyjadřuje naše názory na sporné oblasti';
  ...
  @override
  String get imageSaveOptionDialogContent => 'Vyberte, kam chcete uložit tento a budoucí zpracované snímky. Pokud jste vybrali server, ale aplikaci se je nepodařilo nahrát, uloží se do vašeho zařízení.';
  ...
  @override
  String get createCollectionFailureNotification => 'Nepodařilo se vytvořit sbírku';

  @override
  String get addItemToCollectionTooltip => 'Přidat do sbírky';

  @override
  String get addItemToCollectionFailureNotification => 'Nepodařilo se přidat do sbírky';

  @override
  String get setCollectionCoverFailureNotification => 'Nepodařilo se nastavit obal sbírky';
  ...
  @override
  String get createCollectionDialogNextcloudAlbumLabel2 => 'Album na straně serveru';

  @override
  String get createCollectionDialogNextcloudAlbumDescription2 => 'Vytvořte album na svém serveru, které bude dostupné s jakoukoli aplikací';

  @override
  String get removeCollectionsFailedNotification => 'Nepodařilo se odebrat některé sbírky';
  ...
  @override
  String get trustedCertManagerNoHttpsServerError => 'Není dostupný žádný server';

  @override
  String get trustedCertManagerFailedToRemoveCertError => 'Nepodařilo se odstranit certifikát';

  @override
  String get missingVideoThumbnailHelpDialogTitle => 'Máte problémy s náhledy videí?';
  ...
  @override
  String get dragAndDropRearrangeButtons => 'Přesuňte tlačítka pro změnu jejich pořadí';

  @override
  String get customizeCollectionsNavBarDescription => 'Přesuňte tlačítka pro změnu jejich pořadí, klepněte na tlačítka výše pro jejich minimalizaci';

  @override
  String get customizeButtonsUnsupportedWarning => 'Toto tlačítko nelze přizpůsobit';
  ...
  @override
  String get errorUnauthenticated => 'Neověřený přístup. Pokud problém přetrvává, přihlaste se znovu';

  @override
  String get errorDisconnected => 'Nelze se připojit. Server může být offline nebo vaše zařízení může být odpojeno.';

  @override
  String get errorLocked => 'Soubor je na serveru uzamčen. Zkuste to prosím znovu později';

  @override
  String get errorInvalidBaseUrl => 'Nelze komunikovat. Ujistěte se, že adresa je základní adresou URL vaší instance Nextcloud';

  @override
  String get errorWrongPassword => 'Nelze ověřit. Zkontrolujte prosím uživatelské jméno a heslo';

  @override
  String get errorServerError => 'Chyba serveru. Ujistěte se, že je server správně nastaven';

  @override
  String get errorAlbumDowngrade => 'Toto album nelze upravit, protože bylo vytvořeno pozdější verzí této aplikace. Aktualizujte prosím aplikaci a zkuste to znovu';

  @override
  String get errorNoStoragePermission => 'Chybějící oprávnění k přístupu k úložišti';
