...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get deleteSelectedSuccessNotification => 'Tous les éléments ont été supprimés avec succès';
  ...
  @override
  String get archiveSelectedSuccessNotification => 'Tous les éléments ont été archivés avec succès';
  ...
  @override
  String get unarchiveSelectedSuccessNotification => 'Tous les éléments ont été désarchivés avec succès';
  ...
  @override
  String get deleteFailureNotification => 'Échec de la suppression de l\'élément';

  @override
  String get removeSelectedFromAlbumFailureNotification => 'Échec de la suppression des éléments de l\'album';
  ...
  @override
  String get connectingToServerInstruction => 'En attente de connexion via navigateur';
  ...
  @override
  String get signIn2faHintText => 'Utilisez un mot de passe d\'application si vous avez activé l\'authentification à deux facteurs sur le serveur';
  ...
  @override
  String get serverAddressInputInvalidEmpty => 'Veuillez saisir l\'adresse du serveur';

  @override
  String get usernameInputHint => 'Nom d\'utilisateur';

  @override
  String get usernameInputInvalidEmpty => 'Veuillez entrer votre nom d\'utilisateur';
  ...
  @override
  String get rootPickerSubHeaderText => 'Seules les photos à l\'intérieur des dossiers seront affichées. Appuyez sur Ignorer pour tout inclure';

  @override
  String get rootPickerNavigateUpItemText => '(retourner en arrière)';

  @override
  String get rootPickerUnpickFailureNotification => 'Échec de la désélection de l\'élement';

  @override
  String get rootPickerListEmptyNotification => 'Veuillez choisir au moins un dossier ou appuyez sur ignorer pour tout inclure';

  @override
  String get setupWidgetTitle => 'Commencer';

  @override
  String get setupSettingsModifyLaterHint => 'Vous pouvez modifier cela plus tard dans les paramètres';

  @override
  String get setupHiddenPrefDirNoticeDetail => 'Cette application crée un dossier sur le serveur Nextcloud pour stocker les fichiers de préférences. Veuillez ne pas le modifier ou le supprimer à moins que vous ne prévoyiez de supprimer cette application';
  ...
  @override
  String get settingsLanguageOptionSystemDefaultLabel => 'Utiliser la langue système';
  ...
  @override
  String get settingsExifSupportTrueSubtitle => 'Demande une utilisation plus intense du réseau';
  ...
  @override
  String get settingsAccountLabelDescription => 'Utiliser ce nom pour remplacer l\'URL du server';
  ...
  @override
  String get settingsShareFolderDialogTitle => 'Localisez le dossier de partage';

  @override
  String get settingsShareFolderDialogDescription => 'Ce paramètre correspond au paramètre share_folder dans config.php. Les deux valeurs DOIVENT être identiques.\n\nVeuillez localiser le même dossier que celui défini dans config.php.';

  @override
  String get settingsShareFolderPickerDescription => 'Veuillez localiser le même dossier que celui défini dans config.php. Appuyez sur default si vous n\'avez pas défini le paramètre.';

  @override
  String get settingsPersonProviderTitle => 'Application de reconnaissance faciale';

  @override
  String get settingsServerAppSectionTitle => 'Prise en charge de l\'application serveur';

  @override
  String get settingsPhotosDescription => 'Sélectionner le contenu de l\'onglet photo';
  ...
  @override
  String get settingsViewerDescription => 'Personnaliser le visionneur de vidéo/image';

  @override
  String get settingsScreenBrightnessTitle => 'Luminosité d\'écran';

  @override
  String get settingsScreenBrightnessDescription => 'Remplacer le niveau de luminosité du système';

  @override
  String get settingsForceRotationTitle => 'Ignorer le verrouillage de la rotation';

  @override
  String get settingsForceRotationDescription => 'Faire pivoter l\'écran même lorsque la rotation automatique est désactivée';

  @override
  String get settingsMapProviderTitle => 'Fournisseur de carte';

  @override
  String get settingsViewerCustomizeAppBarTitle => 'Personnaliser la barre d\'applications';

  @override
  String get settingsViewerCustomizeBottomAppBarTitle => 'Personnaliser la barre d\'application inférieure';

  @override
  String get settingsShowDateInAlbumTitle => 'Regrouper les photos par date';

  @override
  String get settingsShowDateInAlbumDescription => 'Appliquer uniquement lorsque l\'album est trié par heure';

  @override
  String get settingsCollectionsCustomizeNavigationBarTitle => 'Personnaliser la barre de navigation';

  @override
  String get settingsImageEditTitle => 'Editeur';

  @override
  String get settingsImageEditDescription => 'Personnaliser l\'amélioration des images et l\'éditeur';

  @override
  String get settingsEnhanceMaxResolutionTitle2 => 'Résolution des images pour l\'amélioration';

  @override
  String get settingsEnhanceMaxResolutionDescription => 'Les photos avec une resolution supérieure seront réduites.\n\nLes images hautes résolutions prennent beaucoup plus de temps et de mémoire à traîter. Baisser cette résolution si l\'application se ferme pendants le traitement de vos photos.';

  @override
  String get settingsImageEditSaveResultsToServerTitle => 'Enregistrer les résultats sur le server';

  @override
  String get settingsImageEditSaveResultsToServerTrueDescription => 'Les résultats sont sauvegardées sur le server, ou sur l\'appareil si l\'envoi échou.';

  @override
  String get settingsImageEditSaveResultsToServerFalseDescription => 'Les résultats sont sauvegardés sur l\'appareil';

  @override
  String get settingsThemeTitle => 'Thème';

  @override
  String get settingsThemeDescription => 'Personnalisez l\'apparence de l\'application';
  ...
  @override
  String get settingsSeedColorDescription => 'Utilisée pour déduire les couleurs de l\'application';

  @override
  String get settingsSeedColorSystemColorDescription => 'Utiliser les couleurs système';
  ...
  @override
  String get settingsSeedColorPickerSystemColorButtonLabel => 'COULEURS SYSTÈME';

  @override
  String get settingsUseBlackInDarkThemeTitle => 'Thème plus sombre';

  @override
  String get settingsUseBlackInDarkThemeTrueDescription => 'Utiliser le noir dans le thème sombre';

  @override
  String get settingsUseBlackInDarkThemeFalseDescription => 'Utiliser le gris foncé dans le thème sombre';
  ...
  @override
  String get settingsAppLockDescription => 'Si cette option est activée, il vous sera demandé de vous authentifier à l\'ouverture de l\'application. Cette fonctionnalité ne vous protège PAS contre les attaques réelles.';

  @override
  String get settingsAppLockSetupBiometricFallbackDialogTitle => 'Choisissez une solution de secours lorsque la biométrie n\'est pas disponible';

  @override
  String get settingsAppLockSetupPinDialogTitle => 'Définir le code PIN pour déverrouiller l\'application';

  @override
  String get settingsAppLockConfirmPinDialogTitle => 'Saisissez à nouveau le même code PIN';

  @override
  String get settingsAppLockSetupPasswordDialogTitle => 'Définir le mot de passe pour déverrouiller l\'application';

  @override
  String get settingsAppLockConfirmPasswordDialogTitle => 'Saisissez à nouveau le même mot de passe';
  ...
  @override
  String get settingsExperimentalDescription => 'Des fonctionnalités qui ne sont pas prêtes pour une utilisation quotidienne';

  @override
  String get settingsExpertTitle => 'Options avancées';

  @override
  String get settingsExpertWarningText => 'Soyer certains de comprendre chaque option avant de continuer';

  @override
  String get settingsClearCacheDatabaseTitle => 'Effacer la base de données';

  @override
  String get settingsClearCacheDatabaseDescription => 'Effacer les données mis en cache et relancer une synchronisation complète avec le server';

  @override
  String get settingsClearCacheDatabaseSuccessNotification => 'Base de données effacé avec succès. Vous pouvez redemander l\'application';

  @override
  String get settingsManageTrustedCertificateTitle => 'Gérer les certificats de confiance';

  @override
  String get settingsUseNewHttpEngine => 'Utiliser le nouveau moteur HTTP';

  @override
  String get settingsUseNewHttpEngineDescription => 'Nouveau moteur HTTP basé sur Chromium, prenant en charge de nouvelles normes telles que HTTP/2* et HTTP/3 QUIC*.\n\nLimitations :\nNous ne pouvons plus gérer les certificats auto-signés. Vous devez importer vos certificats CA dans le magasin de confiance du système pour qu\'ils fonctionnent.\n\n* HTTPS est requis pour HTTP/2 et HTTP/3';
  ...
  @override
  String get settingsCaptureLogsDescription => 'Aider le développeur à diagnostiquer les bugs';

  @override
  String get settingsTranslatorTitle => 'Traducteurs';

  @override
  String get settingsRestartNeededDialog => 'Veuillez redémarrer l\'application pour appliquer les modifications';

  @override
  String get writePreferenceFailureNotification => 'Échec du réglage des préférences';
  ...
  @override
  String get exifSupportNextcloud28Notes => 'Le support côté client complète votre serveur. L\'application traitera les fichiers et les attributs non pris en charge par Nextcloud';

  @override
  String get exifSupportConfirmationDialogTitle2 => 'Activer la prise en charge EXIF côté client ?';

  @override
  String get captureLogDetails => 'Pour prendre des logs pour un rapport de bug :\n\n1. Activez ce paramètre\n2. Reproduisez le problème\n3. Désactivez ce paramètre\n4. Recherchez nc-photos.log dans le dossier de téléchargement\n\n*Si le problème provoque le blocage de l\'application, aucun log ne peut être capturé. Dans ce cas, veuillez contacter le développeur pour plus d\'instructions';
  ...
  @override
  String get rootPickerSkipConfirmationDialogContent2 => 'Tous vos fichiers seront inclus. Cela peut augmenter l\'utilisation de la mémoire et dégrader les performances';
  ...
  @override
  String get downloadFailureNotification => 'Échec du téléchargement du fichier';
  ...
  @override
  String get webSelectRangeNotification => 'Maintenez la touche Maj enfoncée + cliquez pour tout sélectionner entre les deux';

  @override
  String get mobileSelectRangeNotification => 'Appuyez longuement sur un autre élément pour tout sélectionner entre';
  ...
  @override
  String get updateDateTimeFailureNotification => 'Échec de la modification de la date et de l\'heure';

  @override
  String get albumDirPickerHeaderText => 'Choisissez les dossiers à associer';

  @override
  String get albumDirPickerSubHeaderText => 'Seules les photos des dossiers associés seront incluses dans cet album';

  @override
  String get albumDirPickerListEmptyNotification => 'Veuillez choisir au moins un dossier';

  @override
  String get importFoldersTooltip => 'Importer des dossiers';

  @override
  String get albumImporterHeaderText => 'Importer des dossiers sous forme d\'albums';

  @override
  String get albumImporterSubHeaderText => 'Les dossiers suggérés sont répertoriés ci-dessous. Selon le nombre de fichiers sur votre serveur, cela peut prendre un certain temps';
  ...
  @override
  String get editAccountConflictFailureNotification => 'Un compte existe déjà avec les mêmes paramètres';
  ...
  @override
  String get albumEditDragRearrangeNotification => 'Appuyez longuement sur un élément et faites-le glisser pour le réorganiser manuellement';
  ...
  @override
  String get shareSelectedEmptyNotification => 'Sélectionnez quelques photos à partager';
  ...
  @override
  String get restoreSelectedSuccessNotification => 'Tous les éléments ont été restaurés avec succès';
  ...
  @override
  String get restoreFailureNotification => 'Échec de la restauration de l\'élément';

  @override
  String get deletePermanentlyTooltip => 'Supprimer définitivement';

  @override
  String get deletePermanentlyConfirmationDialogTitle => 'Supprimer définitivement';

  @override
  String get deletePermanentlyConfirmationDialogContent => 'Les éléments sélectionnés seront supprimés définitivement du serveur.\n\nCette action est irréversible';

  @override
  String get albumSharedLabel => 'Partagé';

  @override
  String get metadataTaskProcessingNotification => 'Traitement des métadonnées de l\'image en arrière-plan';
  ...
  @override
  String get serverCertErrorDialogTitle => 'Le certificat du serveur ne peut pas être approuvé';

  @override
  String get serverCertErrorDialogContent => 'Le serveur peut être piraté ou quelqu\'un essaie de voler vos informations';

  @override
  String get advancedButtonLabel => 'AVANCÉ';

  @override
  String get whitelistCertDialogTitle => 'Certificat inconnu de la liste blanche ?';
  ...
  @override
  String get whitelistCertButtonLabel => 'ACCEPTER LE RISQUE ET AJOUTER À LA LISTE BLANCHE';
  ...
  @override
  String get emptyTrashbinConfirmationDialogContent => 'Tous les éléments seront définitivement supprimés du serveur.\n\nCette action est irréversible';
  ...
  @override
  String get shareMethodPreviewDescription => 'Partager un aperçu de plus basse qualité aux autres application (ne supporte que les images)';

  @override
  String get shareMethodOriginalFileTitle => 'Fichier original';

  @override
  String get shareMethodOriginalFileDescription => 'Télécharge le fichier original et le partage aux autres applications';

  @override
  String get shareMethodPublicLinkTitle => 'Lien public';

  @override
  String get shareMethodPublicLinkDescription => 'Créez un nouveau lien public sur le serveur. Toute personne disposant du lien peut accéder au fichier';

  @override
  String get shareMethodPasswordLinkTitle => 'Lien protégé par mot de passe';

  @override
  String get shareMethodPasswordLinkDescription => 'Créer un nouveau lien protégé par mot de passe sur le serveur';
  ...
  @override
  String get multipleFilesLinkShareDialogContent => 'Nextcloud ne prend pas en charge le lien de partage pour plusieurs fichiers. L\'application copiera à la place les fichiers dans un nouveau dossier et partagera le dossier à la place.';
  ...
  @override
  String get folderNameInputInvalidCharacters => 'Contient des caractères non valides';
  ...
  @override
  String get unshareLinkShareDirDialogContent => 'Ce dossier a été créé par l\'application pour partager plusieurs fichiers sous forme de lien. Il n\'est désormais plus partagé avec aucun tiers, voulez-vous supprimer ce dossier ?';
  ...
  @override
  String get sharedAlbumInfoDialogContent => 'L\'album partagé permet à plusieurs utilisateurs sur le même serveur d\'accéder au même album. Veuillez lire attentivement les limitations avant de continuer';

  @override
  String get learnMoreButtonLabel => 'EN APPRENDRE PLUS';

  @override
  String get migrateDatabaseProcessingNotification => 'Mise à jour de la base de données';

  @override
  String get migrateDatabaseFailureNotification => 'Échec de la migration de la base de données';
  ...
  @override
  String get homeFolderNotFoundDialogContent => 'Veuillez corriger l\'URL WebDAV indiquée ci-dessous. Vous pouvez trouver l\'URL dans l\'interface Web de Nextcloud.';

  @override
  String get homeFolderInputInvalidEmpty => 'Veuillez saisir le nom de votre dossier personnel';
  ...
  @override
  String get createCollectionDialogAlbumDescription2 => 'Album avec des fonctionnalités supplémentaires, accessible uniquement avec cette application';

  @override
  String get createCollectionDialogFolderLabel => 'Dossier';

  @override
  String get createCollectionDialogFolderDescription => 'Afficher les photos dans un dossier';
  ...
  @override
  String get unfavoriteFailureNotification => 'Échec de la suppression des favoris';

  @override
  String get createCollectionDialogTagLabel => 'Tag';

  @override
  String get createCollectionDialogTagDescription => 'Afficher les photos avec des tags spécifiques';

  @override
  String get addTagInputHint => 'Ajouter un tag';

  @override
  String get tagPickerNoTagSelectedNotification => 'Veuillez ajouter au moins 1 tag';

  @override
  String get backgroundServiceStopping => 'Arrêt du service';

  @override
  String get metadataTaskPauseLowBatteryNotification => 'La batterie est faible';
  ...
  @override
  String get enhanceIntroDialogDescription => 'Vos photos sont traîter sur l\'appareil. Par défaut, elle sont réduite à 2048x1546. Vous pouvez ajuster la résolution dans les paramètres';

  @override
  String get enhanceLowLightTitle => 'Amélioration pour basse lumière';

  @override
  String get enhanceLowLightDescription => 'Augmente la luminosité des photos prise en environnement peu lumineux';
  ...
  @override
  String get deletePermanentlyLocalConfirmationDialogContent => 'Les éléments sélectionné serons supprimer définitivement de l\'appareil.\n\nCette action n\'est pas réversible';

  @override
  String get enhancePortraitBlurTitle => 'Flou d\'arrière plan';

  @override
  String get enhancePortraitBlurDescription => 'Ajoute un effet de flou a l\'arrière de vos photos, fonctionne mieux pour les portraits';
  ...
  @override
  String get enhanceSuperResolution4xDescription => 'Augmente la résolution de vos photos par 4 (voir l\'aide pour plus de détail sur la résolution maximum)';
  ...
  @override
  String get enhanceStyleTransferStyleDialogDescription => 'Transferer le style d\'une image de référence sur vos photos';

  @override
  String get enhanceStyleTransferNoStyleSelectedNotification => 'Choisissez un style';

  @override
  String get enhanceColorPopTitle => 'Augmenter le contraste';

  @override
  String get enhanceColorPopDescription => 'Desature l\'arrière plan des photos, fonctionne mieux avec les portraits';
  ...
  @override
  String get enhanceRetouchDescription => 'Retouche automatiquement vos photos, ameliore l\'éclat des couleurs';

  @override
  String get doubleTapExitNotification => 'Tapper une deuxième fois pour quitter';

  @override
  String get imageEditDiscardDialogTitle => 'Quitter sans enregistrer ?';

  @override
  String get imageEditDiscardDialogContent => 'Vos changements ne sont pas sauvegardés';
  ...
  @override
  String get searchLandingPeopleListEmptyText2 => 'Appuyer sur paramètres pour changer de fournisseur ou aide pour en savoir plus';
  ...
  @override
  String get gpsPlaceAboutDialogContent => 'La localisation affiché n\'est qu\'une estimation et n\'est pas garantie d\'être exact. Ceci ne represente en rien notre point de vu sur des espaces disputés.';
  ...
  @override
  String get imageSaveOptionDialogContent => 'Sélectionner où sauvegarder les images traitées. Si vous choisissez sur le serveur mais que l\'envoi échoué, l\'image sera sauvegardée sur l\'appareil';
  ...
  @override
  String get initialSyncMessage => 'Synchronisation avec le serveur pour la première fois';

  @override
  String get loopTooltip => 'Répéter';

  @override
  String get createCollectionFailureNotification => 'La création de la collection a échouée';

  @override
  String get addItemToCollectionTooltip => 'Ajouter a la collection';

  @override
  String get addItemToCollectionFailureNotification => 'L\'ajout a la collection a échoué';

  @override
  String get setCollectionCoverFailureNotification => 'Le changement de la couverture a échoué';
  ...
  @override
  String get createCollectionDialogNextcloudAlbumDescription2 => 'Créez un album sur votre serveur, accessible avec n\'importe quelle application';

  @override
  String get removeCollectionsFailedNotification => 'La suppression des collections a échouée';
  ...
  @override
  String get trustedCertManagerFailedToRemoveCertError => 'Impossible de supprimer le certificat';

  @override
  String get missingVideoThumbnailHelpDialogTitle => 'Vous rencontrez des problèmes avec les miniatures des vidéos ?';
  ...
  @override
  String get dragAndDropRearrangeButtons => 'Faites un glisser-déposer pour réorganiser les boutons';

  @override
  String get customizeCollectionsNavBarDescription => 'Faites un glisser-déposer pour réorganiser les boutons, appuyez sur les boutons ci-dessus pour les minimiser';

  @override
  String get customizeButtonsUnsupportedWarning => 'Ce bouton ne peut pas être personnalisé';
  ...
  @override
  String get errorUnauthenticated => 'Accès non authentifié. Veuillez vous reconnecter si le problème persiste';

  @override
  String get errorDisconnected => 'Impossible de se connecter. Le serveur peut être hors ligne ou votre appareil peut être déconnecté';

  @override
  String get errorLocked => 'Le fichier est verrouillé sur le serveur. Veuillez réessayer plus tard';

  @override
  String get errorInvalidBaseUrl => 'Impossible de communiquer. Veuillez vous assurer que l\'adresse est l\'URL de base de votre instance Nextcloud';

  @override
  String get errorWrongPassword => 'Impossible à authentifier. Veuillez vérifier le nom d\'utilisateur et le mot de passe';

  @override
  String get errorServerError => 'Erreur du serveur. Veuillez vous assurer que le serveur est correctement configuré';

  @override
  String get errorAlbumDowngrade => 'Impossible de modifier cet album car il a été créé par une version ultérieure de cette application. Veuillez mettre à jour l\'application et réessayer';

  @override
  String get errorNoStoragePermission => 'Exiger une autorisation d\'accès au stockage';
