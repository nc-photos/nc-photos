...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get removeSelectedFromAlbumFailureNotification => 'Error al quitar elementos del álbum';
  ...
  @override
  String get connectingToServerInstruction => 'Por favor inicia sesión con el navegador que se ha abierto';
  ...
  @override
  String get signIn2faHintText => 'Usa una contraseña de aplicación si el servidor tiene activada la autenticación de doble factor.';
  ...
  @override
  String get serverAddressInputInvalidEmpty => 'Introduce la dirección del servidor';
  ...
  @override
  String get rootPickerHeaderText => 'Selecciona las carpetas que serán añadidas';

  @override
  String get rootPickerSubHeaderText => 'Solo se mostrará el contenido de las carpetas seleccionadas. Toca SALTAR para incluir todas';

  @override
  String get rootPickerNavigateUpItemText => '(atrás)';

  @override
  String get rootPickerUnpickFailureNotification => 'Error al desmarcar elemento';

  @override
  String get rootPickerListEmptyNotification => 'Por favor, selecciona al menos una carpeta o toca SALTAR para seleccionar todas';

  @override
  String get setupWidgetTitle => 'Empecemos';

  @override
  String get setupSettingsModifyLaterHint => 'Puedes cambiarlo luego en Ajustes';

  @override
  String get setupHiddenPrefDirNoticeDetail => 'Está aplicación crea una carpeta oculta en Nextcloud para guardar las preferencias. Por favor no la modifiques o elimines a no ser que quieras desinstalar ésta aplicación.';
  ...
  @override
  String get settingsExifSupportTrueSubtitle => 'Requiere un uso mayor de la red';
  ...
  @override
  String get settingsAccountLabelDescription => 'Pon un nombre para mostrarse en lugar de la URL del servidor';
  ...
  @override
  String get settingsShareFolderDialogTitle => 'Ubicación de la carpeta \'share\'';

  @override
  String get settingsShareFolderDialogDescription => 'Ésta configuración corresponde al parametro \'share_folder\' en config.php. Ambos valores DEBEN ser idénticos\n\nPor favor, utiliza la misma carpeta que la configurada en config.php';

  @override
  String get settingsShareFolderPickerDescription => 'Por favor, utiliza la misma carpeta que la configurada en config.php. Toca en predeterminado si no tienes configurado éste parámetro';
  ...
  @override
  String get settingsPhotosDescription => 'Personaliza el contenido de la pestaña \'Fotos\'';
  ...
  @override
  String get settingsViewerDescription => 'Personaliza la visualización de imágenes/vídeos';

  @override
  String get settingsScreenBrightnessTitle => 'Brillo de pantalla';

  @override
  String get settingsScreenBrightnessDescription => 'Establecer nivel de brillo al visualizar';

  @override
  String get settingsForceRotationTitle => 'Forzar rotación automática';

  @override
  String get settingsForceRotationDescription => 'Rotar pantalla aunque la auto-rotación esté desactivada en el sistema';

  @override
  String get settingsMapProviderTitle => 'Proveedor de mapas';

  @override
  String get settingsViewerCustomizeAppBarTitle => 'Personalizar barra de opciones';

  @override
  String get settingsViewerCustomizeBottomAppBarTitle => 'Personalizar barra de opciones inferior';

  @override
  String get settingsShowDateInAlbumTitle => 'Agrupar fotos por fecha';

  @override
  String get settingsShowDateInAlbumDescription => 'Se aplica sólo cuando el álbum esté ordenado por fecha';

  @override
  String get settingsCollectionsCustomizeNavigationBarTitle => 'Personalizar barra de navegación';

  @override
  String get settingsImageEditTitle => 'Editor';

  @override
  String get settingsImageEditDescription => 'Personaliza la edición y retoque de imágenes';

  @override
  String get settingsEnhanceMaxResolutionTitle2 => 'Resolución máxima al guardar retoques';

  @override
  String get settingsEnhanceMaxResolutionDescription => 'Las fotos con mayor resolución que la ajustada serán reducidas.\n\nLas fotos con resolución alta requerirán más memoria y tiempo para procesarlas. Reduce el valor de este ajuste si la aplicación se cuelga.';

  @override
  String get settingsImageEditSaveResultsToServerTitle => 'Guardar en el servidor';

  @override
  String get settingsImageEditSaveResultsToServerTrueDescription => 'Las imágenes editadas se guardarán en el servidor, pero si falla se guardarán en el dispositivo';

  @override
  String get settingsImageEditSaveResultsToServerFalseDescription => 'Las imágenes editadas se guardan en éste dispositivo';
  ...
  @override
  String get settingsSeedColorDescription => 'Usado para extrapolar todos los colores usados en la app';
  ...
  @override
  String get settingsSeedColorPickerSystemColorButtonLabel => 'Usar Material You';

  @override
  String get settingsUseBlackInDarkThemeTitle => 'Tema negro';

  @override
  String get settingsUseBlackInDarkThemeTrueDescription => 'Usar negro puro cuando se activa el tema oscuro';

  @override
  String get settingsUseBlackInDarkThemeFalseDescription => 'Usar gris cuando se activa el tema oscuro';
  ...
  @override
  String get settingsPhotosTabSortByNameTitle => 'Ordenar por nombre de archivo en \'Fotos\'';
  ...
  @override
  String get settingsAppLockDescription => 'Si se habilita, se te pedirá que te autentifiques cuando antes la aplicación. Esta función NO te protege contra ataques del mundo real.';

  @override
  String get settingsAppLockSetupBiometricFallbackDialogTitle => 'Elige otra opción cuando biométrico no está disponible';

  @override
  String get settingsAppLockSetupPinDialogTitle => 'Establece un PIN para desbloquear la aplicación';

  @override
  String get settingsAppLockConfirmPinDialogTitle => 'Introduce el mismo PIN otra vez';

  @override
  String get settingsAppLockSetupPasswordDialogTitle => 'Establece una contraseña para desbloquear la aplicación';

  @override
  String get settingsAppLockConfirmPasswordDialogTitle => 'Introduce la misma contraseña otra vez';
  ...
  @override
  String get settingsExperimentalDescription => 'Características que no están listas para uso diario';

  @override
  String get settingsExpertTitle => 'Avanzado';

  @override
  String get settingsExpertWarningText => 'Por favor asegúrate de que entiendes lo que hace cada opción antes de continuar.';

  @override
  String get settingsClearCacheDatabaseTitle => 'Limpiar base de datos de archivos.';

  @override
  String get settingsClearCacheDatabaseDescription => 'Limpia la información de archivos cacheados y realiza una resincronización completa con el servidor.';

  @override
  String get settingsClearCacheDatabaseSuccessNotification => 'Base de datos limpiada con éxito. Es recomendable que reinicies la aplicación.';

  @override
  String get settingsManageTrustedCertificateTitle => 'Administrar certificados de confianza';

  @override
  String get settingsUseNewHttpEngine => 'Usar nuevo motor HTTP';

  @override
  String get settingsUseNewHttpEngineDescription => 'El nuevo motor HTTP basado en Chromium, soporta nuevos estándares como HTTP/2* y HTTP/3 QUIC*.\n\nLimitaciones:\nYa no podemos administrar los certificados autofirmados. Debes importar tus certificados CA al almacén de confianza del sistema para que funcionen.\n\n* HTTPS requerido para HTTP/2 y HTTP/3 QUIC*.';
  ...
  @override
  String get settingsCaptureLogsDescription => 'Ayuda al desarrollador a diagnosticar fallos';

  @override
  String get settingsTranslatorTitle => 'Traductor';

  @override
  String get settingsRestartNeededDialog => 'Por favor reinicia la aplicación para aplicar los cambios';

  @override
  String get writePreferenceFailureNotification => 'Error al establecer preferencia';
  ...
  @override
  String get exifSupportNextcloud28Notes => 'El soporte para el lado del Cliente complementa a tu servidor. La aplicación procesará los archivos y atributos que Nextcloud no soporta';

  @override
  String get exifSupportConfirmationDialogTitle2 => '¿Habilitar el soporte EXIF para el lado del Cliente?';

  @override
  String get captureLogDetails => 'Para guardar registros y reportar fallos:\n\n1. Habilita ésta opción\n2. Reproduce el fallo\n3. Desabilita ésta opción\n4. Busca nc-photos.log en la carpeta de descargas\n\n*Si el fallo provoca que la aplicación se cierre, no se puede guardar el registro. En ese caso, por favor contacta con el desarrollador para más instrucciones';
  ...
  @override
  String get rootPickerSkipConfirmationDialogContent2 => 'Se incluirán todos tus archivos. Esto puede incrementar el uso de memoria y degradar el rendimiento.';
  ...
  @override
  String get webSelectRangeNotification => 'Mantén Shift + click para seleccionar todo entre medias';

  @override
  String get mobileSelectRangeNotification => 'Mantenga presionado otro elemento para seleccionar todo entre ellos';
  ...
  @override
  String get updateDateTimeFailureNotification => 'Error al modificar fecha y hora';

  @override
  String get albumDirPickerHeaderText => 'Selecciona las carpetas a asociar con el álbum';

  @override
  String get albumDirPickerSubHeaderText => 'Sólo el contenido de las carpetas asociadas se incluirán en éste álbum';

  @override
  String get albumDirPickerListEmptyNotification => 'Por favor selecciona al menos una carpeta';
  ...
  @override
  String get albumImporterSubHeaderText => 'Las carpetas disponibles se muestran a continuación. Dependiendo de la cantidad de archivos en tu servidor, esto podría tardar un rato en terminar.';
  ...
  @override
  String get editAccountConflictFailureNotification => 'Ya existe una cuenta con los mismos ajustes';
  ...
  @override
  String get albumEditDragRearrangeNotification => 'Mantén presionado y arrastra un elemento para reordenarlo manualmente';
  ...
  @override
  String get shareSelectedEmptyNotification => 'Selecciona algunas fotos para compartir';
  ...
  @override
  String get deletePermanentlyConfirmationDialogTitle => 'Borrar PERMANENTEMENTE';

  @override
  String get deletePermanentlyConfirmationDialogContent => 'Los elementos seleccionados se eliminarán permanentemente del servidor.\n\n¡Ésta acción es irreversible!';

  @override
  String get albumSharedLabel => 'Compartido';

  @override
  String get metadataTaskProcessingNotification => 'Procesando metadatos en segundo plano';
  ...
  @override
  String get serverCertErrorDialogTitle => 'No se puede confiar en el certificado del servidor';

  @override
  String get serverCertErrorDialogContent => 'El servidor podría ser hackeado o alguien podría robar su información';

  @override
  String get advancedButtonLabel => 'AVANZADO';

  @override
  String get whitelistCertDialogTitle => '¿Poner en lista blanca certificado desconocido?';
  ...
  @override
  String get whitelistCertButtonLabel => 'ASUMIR RIESGO Y AÑADIR A LISTA BLANCA';
  ...
  @override
  String get emptyTrashbinConfirmationDialogContent => 'Todos los elementos se eliminarán permanentemente del servidor.\n\nÉsta acción es irreversible';
  ...
  @override
  String get shareMethodPreviewDescription => 'Compartir una versión de calidad reducida con otras apps (sólo para imágenes)';

  @override
  String get shareMethodOriginalFileTitle => 'Archivo original';

  @override
  String get shareMethodOriginalFileDescription => 'Descargar el archivo original y compartirlo con otras apps';

  @override
  String get shareMethodPublicLinkTitle => 'Enlace público';

  @override
  String get shareMethodPublicLinkDescription => 'Crea en el servidor un nuevo enlace público. Cualquiera con el enlace puede acceder al archivo';

  @override
  String get shareMethodPasswordLinkTitle => 'Enlace protegido con contraseña';

  @override
  String get shareMethodPasswordLinkDescription => 'Crea en el servidor un nuevo enlace protegido con contraseña';
  ...
  @override
  String get multipleFilesLinkShareDialogContent => 'Nextcloud no soporta compartir enlaces para múltiples archivos. La aplicación en su lugar COPIARÁ los archivos a una nueva carpeta y compartirá esa capeta.';

  @override
  String get folderNameInputHint => 'Nombre de la carpeta';

  @override
  String get folderNameInputInvalidEmpty => 'Introduce un nombre para la carpeta';

  @override
  String get folderNameInputInvalidCharacters => 'Contiene caracteres inválidos';
  ...
  @override
  String get unshareLinkShareDirDialogContent => 'Ésta carpeta fue creada por la app para compartir múltiples archivos en un enlace. Ya no se comparte con nadie, ¿quieres borrarla?';
  ...
  @override
  String get sharedAlbumInfoDialogTitle => 'Presentación de álbumes compartidos';

  @override
  String get sharedAlbumInfoDialogContent => 'Álbumes compartidos permite a múltiples usuarios del mismo servidor acceder al mismo álbum. Por favor lee cuidadosamente las limitaciones antes de continuar';

  @override
  String get learnMoreButtonLabel => 'APRENDER MÁS';

  @override
  String get migrateDatabaseProcessingNotification => 'Actualizando base de datos';

  @override
  String get migrateDatabaseFailureNotification => 'Error al migrar base de datos';
  ...
  @override
  String get homeFolderNotFoundDialogContent => 'Por favor corrige la URL WebDAV que se muestra abajo. Puedes encontrar la URL en la interfaz web de Nextcloud.';

  @override
  String get homeFolderInputInvalidEmpty => 'Por favor introduce el nombre de tu carpeta inicial';
  ...
  @override
  String get createCollectionDialogAlbumDescription2 => 'Álbum con características adicionales, accesible sólo con ésta aplicación';

  @override
  String get createCollectionDialogFolderLabel => 'Carpeta';

  @override
  String get createCollectionDialogFolderDescription => 'Muestra fotos de una carpeta';
  ...
  @override
  String get createCollectionDialogTagDescription => 'Muestra fotos con las etiquetas especificadas';

  @override
  String get addTagInputHint => 'Añadir etiqueta';

  @override
  String get tagPickerNoTagSelectedNotification => 'Por favor añade al menos 1 etiqueta';
  ...
  @override
  String get enhanceIntroDialogDescription => 'Tus fotos son procesadas localmente en tu dispositivo. Por defecto, son reducidas a 2048x1536. Puedes ajustar la resolución de guardado en Ajustes>Editor';

  @override
  String get enhanceLowLightTitle => 'Mejorar poca luz';

  @override
  String get enhanceLowLightDescription => 'Ilumina tu foto tomada en entornos oscuros';
  ...
  @override
  String get deletePermanentlyLocalConfirmationDialogContent => 'Las fotos seleccionadas se eliminarán permanentemente del dispositivo.\n\nÉsta acción es irreversible';

  @override
  String get enhancePortraitBlurTitle => 'Desenfoque de retrato';

  @override
  String get enhancePortraitBlurDescription => 'Desenfoca el fondo de tu foto. Obtendrás mejores resultados en retratos';
  ...
  @override
  String get enhanceSuperResolution4xDescription => 'Incrementa 4 veces la resolución original de tu foto (mira la ayuda para saber cómo se aplica la máxima resolución)';
  ...
  @override
  String get enhanceStyleTransferStyleDialogDescription => 'Transfiere a tu foto el estilo de una imagen elegida';

  @override
  String get enhanceStyleTransferNoStyleSelectedNotification => 'Por favor, elige un estilo';

  @override
  String get enhanceColorPopTitle => 'Resaltar color';

  @override
  String get enhanceColorPopDescription => 'Reduce la saturación del fondo de tu foto. Obtendrás mejores resultados en retratos';
  ...
  @override
  String get enhanceRetouchDescription => 'Retoca tu foto automáticamente. Mejora el color y el estado general';
  ...
  @override
  String get searchLandingPeopleListEmptyText2 => 'Toca ajustes para elegir un proveedor o ayuda para aprender más';
  ...
  @override
  String get gpsPlaceAboutDialogContent => 'Los lugares mostrados aquí sólo son una estimación y no garantizan ninguna precisión.';
  ...
  @override
  String get imageSaveOptionDialogContent => 'Selecciona dónde guardar ésta y las futuras imágenes. Si eliges Servidor y la app falla al subirlo, se guardará en el dispositivo.';
  ...
  @override
  String get initialSyncMessage => 'Sincronizando con tu servidor por primera vez';
  ...
  @override
  String get addItemToCollectionFailureNotification => 'Error al añadir a colección';

  @override
  String get setCollectionCoverFailureNotification => 'Error al establecer portada de colección';
  ...
  @override
  String get createCollectionDialogNextcloudAlbumLabel2 => 'Álbum lado Servidor';

  @override
  String get createCollectionDialogNextcloudAlbumDescription2 => 'Crea un álbum en tu servidor, accesible con cualquier aplicación.';

  @override
  String get removeCollectionsFailedNotification => 'Error al quitar algunas colecciones';
  ...
  @override
  String get trustedCertManagerNoHttpsServerError => 'No hay servidores disponibles';

  @override
  String get trustedCertManagerFailedToRemoveCertError => 'Fallo al quitar certificado';

  @override
  String get missingVideoThumbnailHelpDialogTitle => '¿Problemas con las miniaturas de vídeos?';
  ...
  @override
  String get dragAndDropRearrangeButtons => 'Arrastra y suelta para reordenar los botones';

  @override
  String get customizeCollectionsNavBarDescription => 'Arrastra y suelta para reordenar los botones, toca cada botón para minimizarlo';

  @override
  String get customizeButtonsUnsupportedWarning => 'Este botón no se puede personalizar';
  ...
  @override
  String get errorUnauthenticated => 'No estás autentificado. Por favor inicia sesión otra vez si el problema continúa.';

  @override
  String get errorDisconnected => 'No se pudo conectar. El servidor no está en línea o tu dispositivo está desconectado.';

  @override
  String get errorLocked => 'Archivo bloqueado en el servidor. Inténtalo de nuevo más tarde.';

  @override
  String get errorInvalidBaseUrl => 'No se pudo comunicar. Asegúrate que la dirección es la URL base de tu Nextcloud.';

  @override
  String get errorWrongPassword => 'No se pudo autentificar. Verifica tu usuario y contraseña.';

  @override
  String get errorServerError => 'Error del servidor. Asegúrate que el servidor está configurado correctamente.';

  @override
  String get errorAlbumDowngrade => 'No puede modificarse este álbum ya que fue creado por una versión más reciente de esta app. Por favor, actualiza la app e inténtalo de nuevo.';

  @override
  String get errorNoStoragePermission => 'Se requiere permiso de acceso al almacenamiento';
