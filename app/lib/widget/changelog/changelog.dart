...
part 'changelog_550.dart';
part 'changelog_560.dart';
part 'changelog_570.dart';
part 'changelog_580.dart';
part 'changelog_590.dart';
part 'changelog_600.dart';
part 'changelog_610.dart';
part 'changelog_630.dart';
part 'changelog_640.dart';
part 'changelog_650.dart';
part 'changelog_660.dart';
part 'changelog_662.dart';
part 'changelog_663.dart';
part 'changelog_670.dart';
part 'changelog_680.dart';
part 'changelog_690.dart';
part 'changelog_700.dart';
part 'changelog_710.dart';
part 'changelog_720.dart';
part 'changelog_730.dart';
part 'changelog_740.dart';
part 'changelog_750.dart';
part 'changelog_760.dart';
part 'changelog_770.dart';
part 'changelog_780.dart';
part 'changelog_782.dart';
part 'changelog_790.dart';
part 'changelog_800.dart';
part 'changelog_810.dart';
part 'changelog_820.dart';
part 'changelog_830.dart';
part 'changelog_832.dart';
part 'changelog_840.dart';
part 'changelog_850.dart';
part 'changelog_860.dart';
part 'changelog_870.dart';
part 'changelog_880.dart';
part 'changelog_890.dart';
part 'changelog_900.dart';
...
final _changelogs = <int, List<Widget> Function(BuildContext)>{
  9000: (_) => const [_Changelog900()],
  8900: (_) => const [_Changelog890()],
  8800: (_) => const [_Changelog880()],
  8700: (_) => const [_Changelog870()],
  8600: (_) => const [_Changelog860()],
  8500: (_) => const [_Changelog850()],
  8400: (_) => const [_Changelog840()],
  8302: (_) => const [_Changelog832()],
  8300: (_) => const [_Changelog830()],
  8200: (_) => const [_Changelog820()],
  8100: (_) => const [_Changelog810()],
  8000: (_) => const [_Changelog800()],
  7900: (_) => const [_Changelog790()],
