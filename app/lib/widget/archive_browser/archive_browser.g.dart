...
extension _$_WrappedArchiveBrowserStateNpLog on _WrappedArchiveBrowserState {
  ...
  static final log = Logger(
    "widget.archive_browser.archive_browser._WrappedArchiveBrowserState",
  );
}
...
extension _$__NpLog on __ {
  ...
  static final log = Logger("widget.archive_browser.archive_browser.__");
}
...
extension _$_SelectionAppBarNpLog on _SelectionAppBar {
  ...
  static final log = Logger(
    "widget.archive_browser.archive_browser._SelectionAppBar",
  );
}
...
extension _$_BlocNpLog on _Bloc {
  ...
  static final log = Logger("widget.archive_browser.archive_browser._Bloc");
}
...
extension _$_ContentListBodyNpLog on _ContentListBody {
  ...
  static final log = Logger(
    "widget.archive_browser.archive_browser._ContentListBody",
  );
}
