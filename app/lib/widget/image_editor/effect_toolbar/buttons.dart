    ...
    return _BlocBuilder(
      ...
      builder:
          (context, state) => ToolbarButton(
            ...
            onPressed: () {
              context.addEvent(
                const _ToggleActiveTool(PixelToolType.pixelation),
              );
            },
                  ...
                  (context, sketchOptionType) => Row(
                    children: [
                      ...
                      ChoiceChip(
                        ...
                        selected:
                            sketchOptionType == _SketchOptionType.hatching,
                        showCheckmark: false,
                        visualDensity: const VisualDensity(
                          horizontal: VisualDensity.minimumDensity,
                          vertical: VisualDensity.minimumDensity,
                        ...
                        onSelected: (value) {
                          context.addEvent(
                            const _SetSketchOptionType(
                              _SketchOptionType.hatching,
                            ),
                          );
                        },
                      ),
            ...
            builder:
                (context, state) => switch (state.sketchOptionType) {
                  ...
                  _SketchOptionType.hatching => StatefulSlider(
                    key: Key(
                      PixelToolType.sketch.name +
                          _SketchOptionType.hatching.name,
                    ),
                    initialValue:
                        (state.filters[PixelToolType.sketch]
                                as _SketchArguments)
      ...
      child: Column(
        ...
        children: [
                  ...
                  (context, toonOptionType) => Row(
                    children: [
                      ...
                      ChoiceChip(
                        ...
                        selected:
                            toonOptionType == _ToonOptionType.quantization,
                        showCheckmark: false,
                        visualDensity: const VisualDensity(
                          horizontal: VisualDensity.minimumDensity,
                          vertical: VisualDensity.minimumDensity,
                        ...
                        onSelected: (value) {
                          context.addEvent(
                            const _SetToonOptionType(
                              _ToonOptionType.quantization,
                            ),
                          );
                        },
                      ),
          ...
          _BlocBuilder(
            ...
            builder:
                (context, state) => switch (state.toonOptionType) {
                  _ToonOptionType.edge => StatefulSlider(
                    key: Key(
                      PixelToolType.toon.name + _ToonOptionType.edge.name,
                    ),
                    initialValue:
                  ...
                  _ToonOptionType.quantization => StatefulSlider(
                    key: Key(
                      PixelToolType.toon.name +
                          _ToonOptionType.quantization.name,
                    ),
                    initialValue:
                        (state.filters[PixelToolType.toon] as _ToonArguments)
                            .quantization,
