...
/// An immutable 32 bit color value in ARGB format copied from Flutter 3.24.
///
...
class ColorInt {
  ...
  const ColorInt(int value) : value = value & 0xFFFFFFFF;
  ...
  ColorInt withAlpha(int a) {
    return ColorInt.fromARGB(a, red, green, blue);
  }
  ...
  ///
  /// Out of range values will have unexpected effects.
  ColorInt withOpacity(double opacity) {
  ...
  ///
  /// Out of range values will have unexpected effects.
  ColorInt withRed(int r) {
    return ColorInt.fromARGB(alpha, r, green, blue);
  }
  ...
  ///
  /// Out of range values will have unexpected effects.
  ColorInt withGreen(int g) {
    return ColorInt.fromARGB(alpha, red, g, blue);
  }
  ...
  ///
  /// Out of range values will have unexpected effects.
  ColorInt withBlue(int b) {
    return ColorInt.fromARGB(alpha, red, green, b);
  }
  ...
  static ColorInt? lerp(ColorInt? a, ColorInt? b, double t) {
    if (b == null) {
      if (a == null) {
        return null;
      } else {
...
ColorInt _scaleAlpha(ColorInt a, double factor) {
